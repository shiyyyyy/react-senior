...
class Login extends Component {
  ...
  handleSubmit = async (err, values) => {
    ...
    if (!err) {
      let r = await req('/api/pub/login/'+sys.site,{ ...values, type });

      localStorage[sys.site+'_sid'] = r.sid;
      localStorage[sys.site+'_role'] = JSON.stringify(r.role);
      ...
      window.location.href = redirect || '/'+sys.site;
    }
  };
  onTabChange = type => {
    this.setState({
    ...
    return (
      <div className={styles.main}>
        <LoginComponents
          ...
          onSubmit={(err, values)=>this.handleSubmit(err,values).catch(log)}
          onCreate={form => {
            this.loginForm = form;
          }}
        >
